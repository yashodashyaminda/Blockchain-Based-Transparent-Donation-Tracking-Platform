...
export declare class DurableExecutionAlreadyStartedException extends __BaseException {
  ...
  Message?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<DurableExecutionAlreadyStartedException, __BaseException>,
  );
}
...
export declare class SerializedRequestEntityTooLargeException extends __BaseException {
  ...
  Type?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<SerializedRequestEntityTooLargeException, __BaseException>,
  );
}
...
export declare class ProvisionedConcurrencyConfigNotFoundException extends __BaseException {
  ...
  Type?: string | undefined;
  constructor(
    opts: __ExceptionOptionType<ProvisionedConcurrencyConfigNotFoundException, __BaseException>,
  );
}
