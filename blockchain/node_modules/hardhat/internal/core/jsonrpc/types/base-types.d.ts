...
export declare const rpcData: t.Type<Buffer<ArrayBufferLike>, Buffer<ArrayBufferLike>, unknown>;
export declare const rpcParity: t.Type<Buffer<ArrayBufferLike>, Buffer<ArrayBufferLike>, unknown>;
export declare const rpcHash: t.Type<Buffer<ArrayBufferLike>, Buffer<ArrayBufferLike>, unknown>;
...
export declare const rpcAddress: t.Type<Buffer<ArrayBufferLike>, Buffer<ArrayBufferLike>, unknown>;
