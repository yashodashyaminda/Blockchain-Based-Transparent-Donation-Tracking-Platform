...
export declare class TasksDSL {
    readonly internalTask: {
        <TaskArgumentsT extends unknown>(name: string, description?: string, action?: ActionType<TaskArgumentsT>): TaskDefinition;
        <TaskArgumentsT extends unknown>(name: string, action: ActionType<TaskArgumentsT>): TaskDefinition;
    };
