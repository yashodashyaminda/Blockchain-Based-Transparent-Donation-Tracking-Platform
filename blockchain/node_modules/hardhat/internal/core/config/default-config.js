...
exports.defaultHardhatNetworkParams = {
    ...
    chains: new Map([
        [
            11155111, // sepolia
            {
                hardforkHistory: new Map([
                    ...
                    [hardforks_1.HardforkName.MERGE, 1_450_409],
                    [hardforks_1.HardforkName.SHANGHAI, 2_990_908],
                    [hardforks_1.HardforkName.CANCUN, 5_187_023],
                    [hardforks_1.HardforkName.PRAGUE, 7_836_331],
                ]),
            },
        ],
        ...
        [
            ...
            {
                hardforkHistory: new Map([
                    [hardforks_1.HardforkName.SHANGHAI, 11_404_279],
                    [hardforks_1.HardforkName.CANCUN, 41_263_126],
                ]),
            },
        ],
        [
