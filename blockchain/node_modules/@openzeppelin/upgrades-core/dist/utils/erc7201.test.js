...
(0, ava_1.default)('calculateERC7201StorageLocation - odd-length intermediate hash', t => {
    t.is((0, erc7201_1.calculateERC7201StorageLocation)('ns2'), '0xa61069020885c09e922542fb3fa98c8d50e6481fc1251ff86c3319a70f0f7d00');
});
...
(0, ava_1.default)('calculateERC7201StorageLocation - leading-zero-byte intermediate hash', t => {
    t.is((0, erc7201_1.calculateERC7201StorageLocation)('ns297'), '0xe06f9faa11c8032ea604e1764972c1a5594987f1678d8fabf921c28d1a7a4c00');
});
