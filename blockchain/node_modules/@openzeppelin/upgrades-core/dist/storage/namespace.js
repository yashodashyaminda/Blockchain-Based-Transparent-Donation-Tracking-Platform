...
const erc7201_builtin_1 = require("../utils/erc7201-builtin");
...
function checkCustomLayoutClashWithNamespace(contractDef, storageLocation, contractName, src) {
    ...
    const baseSlotNormalized = (0, erc7201_builtin_1.resolveBaseSlot)(contractDef.storageLayout.baseSlotExpression);
    if (baseSlotNormalized !== undefined && baseSlotNormalized === (0, erc7201_1.calculateERC7201StorageLocation)(namespaceId)) {
...
function warnIfCustomLayoutAndNamespacesFound(namespacesWithSrc, decodeSrc, origContractDef) {
    if (Object.entries(namespacesWithSrc).length > 0 && origContractDef.storageLayout !== undefined) {
        ...
        if ((0, erc7201_builtin_1.getErc7201BuiltinNamespaceId)(origContractDef.storageLayout.baseSlotExpression) !== undefined) {
            return;
        }
